...
# This migration comes from decidim_enhanced_textwork (originally 20180326091532)

class CreateDecidimEnhancedTextworkCollaborativeDrafts < ActiveRecord::Migration[5.1]
  def change
    create_table :decidim_enhanced_textwork_collaborative_drafts do |t|
